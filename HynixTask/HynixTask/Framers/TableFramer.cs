...
namespace HynixTask.Framers
{
    public class TableFramer
    {
        ...
        public void Write(Format format = Framers.Format.Default)
        {
            switch (format)
            {
                case Framers.Format.Default:
                    Console.WriteLine(ToString());
                    break;
                case Framers.Format.MarkDown:
                    Console.WriteLine(ToMarkDownString());
                    break;
                case Framers.Format.Alternative:
                    Console.WriteLine(ToStringAlternative());
                    break;
                case Framers.Format.Minimal:
